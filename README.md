...
En este proyecto se ha incoporado instancias de clases dentro de la biblioteca OpenAI para crear un asistente de IA que nos busque información dentro del Pdf1.
También se ha creado un panel interactivo con Power Bi para visualizar los datos y por último se ha llevado toda la información a una app de streamlit. 
...
* Desarrollo de App con Streamlit.
 ...
 [APP](https://github.com/AleDV89/Dublin_AirBnb/blob/main/app_dublin.py)
